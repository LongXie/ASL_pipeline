function OutlierCleaning_SCOREwithrange_session...
    (session_dir, anat_dir, infile_gz, out_folder, out_filename_gz, out_stat, LOGTXT)
...
csf_prob_gz = fullfile(anat_dir, 'c3rMPRAGE.nii.gz');
...
for r = 1:nruns
    ...
    % SCORE
    [recon, ~, oidx] = SCORE_core(cbfloc, gmloc, wmloc, csfloc, thresh, range);
...
cd(anat_dir)
delete(gm_filename, wm_filename, csf_filename);
