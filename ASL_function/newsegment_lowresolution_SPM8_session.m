function newsegment_lowresolution_SPM8_session(session_dir, MPRAGE_gz, func_gz, out_folder, LOGTXT)
...
spm('defaults', 'FMRI');
matlabbatch{1}.spm.tools.preproc8.channel.vols = {file_ranat};
